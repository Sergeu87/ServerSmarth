...
public class Device {
    ...
    @JacksonXmlElementWrapper(localName = "access_levels")
    @JacksonXmlProperty(localName = "access_level")
    private String[] accessLevel;
    @JacksonXmlElementWrapper(localName = "users_blocked")
    @JacksonXmlProperty(localName = "user_blocked")
