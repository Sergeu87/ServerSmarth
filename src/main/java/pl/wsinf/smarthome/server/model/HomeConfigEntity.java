 ...
 */
@JacksonXmlRootElement(localName = "house_config")
public class HomeConfigEntity {
    ...
    @JacksonXmlElementWrapper(localName = "device_types")
    ...
    private House house;
    @JacksonXmlElementWrapper(localName = "floors")
    ...
    @JacksonXmlElementWrapper(localName = "division_types")
    @JacksonXmlProperty(localName = "division_type")
    private List<DivisionType> divisionTypeList;
    @JacksonXmlElementWrapper(localName = "users")
    @JacksonXmlProperty(localName = "user")
    private List<User> userList;
    @JacksonXmlElementWrapper(localName = "scalar_values")
    @JacksonXmlProperty(localName = "scalar_value")
    private List<ScalarValueType> scalarValueList;
    @JacksonXmlElementWrapper(localName = "enum_values")
    @JacksonXmlProperty(localName = "enum_value")
